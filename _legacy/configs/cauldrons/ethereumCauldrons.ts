...
const config: Array<CauldronConfig> = [
  ...
  },
  {
    ...
    cauldronSettings: {
      ...
      isDegenBox: true,
      strategyLink:
        "https://medium.com/magicinternetfrens-money/our-ust-strategy-the-first-application-of-the-magic-potentialities-of-degenbox-ea35f13d6b5e",
      isDepreciated: true,
      acceptUseDefaultBalance: false,
      healthMultiplier: 10,
      hasAccountBorrowLimit: false,
