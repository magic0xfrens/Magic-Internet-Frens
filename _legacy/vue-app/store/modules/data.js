...
export default {
  state: {
    ...
    spellStakeData: getAndParseFrenStakeData(),
    ...
    bFrenData: getAndParseBFrenData(),
  },
  ...
  mutations: {
    ...
    setFrenStakeData(state, payload) {
      state.spellStakeData.isCreated = true;
      state.spellStakeData.data = payload;
      localStorage.setItem(LS_FREN_STAKE_KEY, bigintStringify(payload));
    },
    ...
    setBFrenStakeData(state, payload) {
      state.bFrenData.isCreated = true;
      state.bFrenData.data = payload;
      localStorage.setItem(LS_BFREN_DATA, bigintStringify(payload));
    },
  },
  ...
  getters: {
    ...
    getFrenStakeData: (state) => state.spellStakeData,
    ...
    getBFrenData: (state) => state.bFrenData,
  },
};
