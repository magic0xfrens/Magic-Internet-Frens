export default {
  ...
  sanctionAddress: {
    ...
    msg: "It looks like the address you have connected to Magic Internet Frens UI is on a Sanction List. Magic Internet Frens Money is not offering services to sanctioned addresses.",
    type: "error",
  },
