...
const WARNINGS_BTN_TEXT = {
  ...
  [WARNING_TYPES.USER_MAX_TO_BORROW]: "MIF borrow limit exceed",
  ...
  [WARNING_TYPES.SFREN_LOCKED]: "sFren is locked",
...
export const validateCookByAction = (
  ...
  validationErrors = validateSFrenLocked(
    validationErrors,
    cauldron,
    actionConfig
  );
...
const validateSFrenLocked = (
  ...
  if (isCollateralLocked && collateralTokenAmount.gt(0))
    validationErrors.push(WARNING_TYPES.SFREN_LOCKED);
