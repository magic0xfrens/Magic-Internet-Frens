...
export const LS_FARMS_LIST_KEY = "magicinternetfrensFarmList";
export const LS_USER_POSITION_KEY = "magicinternetfrensUserPositions";
export const LS_CAULDRONS_LIST_KEY = "magicinternetfrensCauldronsList";
export const LS_BENTOBOX_DATA_KEY = "magicinternetfrensBentoBoxData";
export const LS_POOLS_LIST_KEY = "magicinternetfrensPoolsList";
export const LS_POOL_FARMS_LIST_KEY = "magicinternetfrensPoolFarmsList";
export const LS_FREN_STAKE_KEY = "magicinternetfrensFrenStakeData";
export const LS_MAGIC_GLP_STAKE_KEY = "magicinternetfrensMagicGlpStakeData";
export const LS_MAGIC_GLP_STAKE_CHART_KEY = "magicinternetfrensMagicGlpChartData";
export const LS_MAGIC_APE_STAKE_KEY = "magicinternetfrensMagicApeStakeData";
export const LS_MAGIC_APE_STAKE_CHART_KEY = "magicinternetfrensMagicApeChartData";
export const LS_POOL_CREATION_CUSTOM_TOKENS_KEY =
  "magicinternetfrensPoolCreationCustomTokens";
export const LS_ELIXIR_RARE_KEY = "magicinternetfrensElixirRate";
export const LS_BFREN_DATA = "magicinternetfrensBFrenData";
...
export const getAndParseFrenStakeData = () => {
  const lsFrenStakeData = localStorage.getItem(LS_FREN_STAKE_KEY);

  if (!lsFrenStakeData) {
    return { data: [], isCreated: false };
  }

  const spellStakeData = JSON.parse(lsFrenStakeData);
...
export const getAndParseBFrenData = () => {
  const lsBFrenData = localStorage.getItem(LS_BFREN_DATA);

  if (!lsBFrenData) {
    return { data: [], isCreated: false };
  }

  const bFrenData = JSON.parse(lsBFrenData);

  const data = bFrenData.map((item: any) => jsonBigIntTransform(item));
