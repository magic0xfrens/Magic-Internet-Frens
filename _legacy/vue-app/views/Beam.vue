<template>
  <div class="beam-view" v-if="beamInfoObject">
    <div class="beam">
      <!-- <div class="spell-message" v-if="tokenType === FREN_ID">
      ...
      <div class="beam-header">
        <div class="title-desc">
          ...
          <p class="description">Move Your MIF Across Networks</p>
        </div>
...
import { MIF_ID, FREN_ID } from "@/constants/beam";
