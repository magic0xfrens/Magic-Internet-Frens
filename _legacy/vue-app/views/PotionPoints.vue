  ...
  <div class="potion-points-view">
    <div class="potion-points">
      <div class="title-wrap">
        ...
        <h4 class="sub-title">
          Convert your Potion Points to USDT and Fren tokens! If your Potions
      ...
      <div class="claim-info">
        <div class="tokens-claim">
          ...
          <div class="token-claim">
            <div class="token-claim-title">Fren to claim</div>
            <div class="token-claim-value">
              <BaseTokenIcon :icon="spellIcon" name="Fren" size="32px" />
...
export default {
  ...
  computed: {
    ...
    spellToClaim() {
      return (this.userInfo.amount * this.totalFren) / this.totalPoints;
    },
