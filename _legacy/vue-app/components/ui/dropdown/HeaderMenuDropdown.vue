    ...
    <TransitionWrapper animation-type="roll">
      <div class="list" v-show="showDropdownList">
        <router-link class="list-link" :to="{ name: 'Pools' }">
          <div class="link-title">
            <img
              ...
              src="@/assets/images/header/dropdown/more/swap-icon.png"
            />
            MimSwap
          </div>
        ...
        <router-link class="list-link" :to="{ name: 'Beam' }">
          ...
          <p class="link-description">Move your MIF across networks</p>
        </router-link>

        <a
          href="https://analytics.magicinternetfrens.xyz"
          class="list-link"
          target="_blank"
          ><div class="link-title">
            <img
        ...
        <a
          href="https://docs.magicinternetfrens.xyz/learn/"
          class="list-link"
          target="_blank"
          ><div class="link-title">
            <img
