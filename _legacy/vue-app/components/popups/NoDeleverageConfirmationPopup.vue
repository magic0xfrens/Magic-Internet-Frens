<template>
  <div class="popup-content">
    <h3 class="title">Mint MIF against sdeUSD</h3>
    ...
    <div class="popup-content-wrap">
      ...
      <p class="description-text">
        ...
        all, unless you have substantial additional capital in MIF, held outside
      ...
      <p class="repayment">
        ...
        <span class="mim-repay">
          <BaseTokenIcon :icon="mimIcon" name="MIF" size="24px" />
