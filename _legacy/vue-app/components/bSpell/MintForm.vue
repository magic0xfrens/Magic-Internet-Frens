<template>
  <div class="mint-form" v-if="bFrenInfo">
    <div class="inputs-wrap">
      <BaseTokenInput
        :value="inputValue"
        :icon="bFrenInfo.spell?.icon"
        :name="bFrenInfo.spell?.name"
        :max="bFrenInfo.spell?.balance"
    ...
    <div class="description">
      <img class="left-icon" src="@/assets/images/bFren/timer.png" alt="" />
      <p class="description-text">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
        veniam,
      </p>
      <img class="right-icon" src="@/assets/images/bFren/timer.png" alt="" />
    </div>
...
export default {
  ...
  computed: {
    ...
    isInsufficientBalance() {
      return this.inputAmount > (this.bFrenInfo?.spell?.balance ?? 0n);
    },
    ...
    isTokenApproved() {
      ...
      if (!this.bFrenInfo) return true;
      return this.bFrenInfo.spell?.approvedAmount >= this.inputAmount;
    },
  ...
  methods: {
    ...
    async mintHandler() {
      try {
        ...
        await mint(this.bFrenInfo!.tokenBank, this.inputAmount, this.account);
