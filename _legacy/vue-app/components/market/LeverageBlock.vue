    ...
    borrowInputAmount() {
      if (this.useCustomBorrowValue) {
        ...
        return trimZeroDecimals(
          utils.formatUnits(this.borrowInputValue, MIF_DECIMALS)
        );
      }
      ...
      const borrowInputAmount = trimZeroDecimals(
        utils.formatUnits(amount, MIF_DECIMALS)
      );
    ...
    updateLeverageAmounts() {
      ...
      if (this.useCustomBorrowValue) {
        ...
        this.multiplier = Number(
          formatToFixed(String(utils.formatUnits(multiplier, MIF_DECIMALS)), 2)
        );
      }
