  ...
  computed: {
    ...
    tooltipText() {
      return this.isProfit
        ? "Dynamic Bonus may vary depending on current $MIF liquidity and will result in a profit when opening/closing a position."
        : "Dynamic Fees may vary depending on current $MIF liquidity and it is not collected by the protocol. The closer $MIF is trading to $1, the lower the fee.";
    },
