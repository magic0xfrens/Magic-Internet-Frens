  ...
  <div class="farms-info">
    <div class="title-desc">
      ...
      <p class="description">
        <span class="desc-line">
          Enjoy the best yields for LPing MIF or Fren
        </span>
      </p>
    </div>
    ...
    <div class="reward-cards" v-if="account">
      <div class="reward-card spell">
        <h4 class="reward-title">Total Fren Rewards</h4>
        <div class="reward-values">
          <div class="token-amount">
            <img
              ...
              alt="FREN"
            />
            {{ formattedFren.amount }}
          </div>
          <span class="token-usd-equivalent">{{ formattedFren.usd }}</span>
        </div>
      </div>
