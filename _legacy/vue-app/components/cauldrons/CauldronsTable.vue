...
export default {
  ...
  data() {
    return {
      ...
      tableKeys: [
        ...
        {
          tableKey: "TMB",
          tooltip: "Total MIF Borrowed.",
          isSortingCriterion: true,
        },
        {
          tableKey: "MIFS LB",
          tooltip: "MIFs left to be Borrowed.",
          isSortingCriterion: true,
        },
        {
          tableKey: "Interest",
  ...
  methods: {
    ...
    getSortKey(cauldron, key) {
      ...
      if (key === "MIFS LB") return cauldron.mainParams.mimLeftToBorrow;
...
.deprecated-btn {
  ...
  padding: 9px;
  border-radius: 10px;
  border: 2px solid var(--Primary-Solid, #F7931A);
