<template>
  <div v-if="isArbitrumChain">
    ...
    <div class="farm-cards-wrap">
      <h4 class="farm-title">Explore the Magic Internet Frens ecosystem on Arbitrum!</h4>
...
export default {
  ...
  methods: {
    ...
    async createFarmInfo(): Promise<void> {
      const farmConfig = getFarmConfig(this.MIF2CrvFarmId, ARBITRUM_CHAIN_ID);
