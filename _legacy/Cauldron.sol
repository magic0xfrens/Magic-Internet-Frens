...
import  "./Utils/CauldronUtils.sol";
...
contract Cauldron is ReentrancyGuard  {
    ...
    address public constant MIMANA_ADDRESS = 0xD3e1703F9540BeC29758eea2c09E6C46F6443189;
...
function getPositionValue(uint256 tokenId) public view  returns (
        ...
        //uint160 sqrtRatioBX96 = TickMath.getSqrtRatioAtTick(_tickUpper);
         ...
         //(amount0,amount1) = LiquidityAmounts.getAmountsForLiquidity(sqrtRatioX96,sqrtRatioAX96, sqrtRatioBX96,_liquidity);
        

         return (_liquidity,_token0,_token1,_tickLower,_tickUpper);
        // Further logic to calculate value based on liquidity, token0, token1...
    }
