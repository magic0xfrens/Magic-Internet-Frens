...
| fixer-S06 | S06 queue seniority (headline) + R2A (small-loss shedding) | contracts/solidity/test/attacks/S06_PerpVaultSolvency.t.sol | test_S06_POC_RealEngine_QueueingBeforeBadDebtShedsAllOfItOnLpB, test_R2A_SmallLossFallsEntirelyOnTheStakerWhoStayed (new) | CLAIMED | Test-only. No contract file claimed; PerpVault.sol untouched. |
