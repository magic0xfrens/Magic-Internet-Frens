...
export default function MyWizards() {
  ...
  return (
    <div className="mif">
      <div className="mif__grain" aria-hidden />
      ...
      {isConnected && <GenesisClaimPanel />}

      {/* ── cast the spell / dividend ── */}
      {isConnected && <DividendPanel />}
      ...
      {/* ── volume-forged creatures ── */}
      {isConnected && <ForgedCreatures />}
...
const css = `
  ...
  /* atmosphere */
  .mif__grain { position: fixed; inset: 0; pointer-events: none; opacity: 0.05; z-index: 0;
  ...
  .mif > *:not(.mif__grain):not(.mif__embers) { position: relative; z-index: 1; max-width: 1200px; margin-left: auto; margin-right: auto; }
  ...
  .mif__addr { font-family: "DM Mono", monospace; font-size: 12px; color: #b8adcc; padding: 8px 14px; border-radius: 20px;
    background: rgba(28,20,54,0.6); border: 1px solid rgba(213,253,81,0.14); }
  .mif__refresh { width: 36px; height: 36px; display: grid; place-items: center; border-radius: 10px; cursor: pointer; color: #8f83b8;
  ...
  .mif__stat { padding: 16px 18px; border-radius: 14px; display: flex; flex-direction: column; gap: 5px;
  ...
  .mif__error { display: flex; align-items: center; justify-content: space-between; gap: 14px; flex-wrap: wrap;
    padding: 13px 18px; margin-bottom: 20px; border-radius: 12px; font-size: 13px; color: #ff4d6d;
    background: rgba(255,77,109,0.06); border: 1px solid rgba(255,77,109,0.22); }
  .mif__retry { padding: 7px 16px; border-radius: 18px; font: 600 11px/1 "DM Mono", monospace; letter-spacing: 0.06em; cursor: pointer;
  ...
  .mif__empty { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; text-align: center;
    min-height: 340px; padding: 48px; border-radius: 20px;
  ...
  .mif__cta { margin-top: 10px; padding: 13px 30px; border-radius: 24px; font: 700 13px/1 "DM Sans", sans-serif; letter-spacing: 0.03em; cursor: pointer; text-decoration: none;
  ...
  .mif__card { text-align: left; padding: 0; overflow: hidden; border-radius: 16px; cursor: pointer;
  ...
  .mif__badge { position: absolute; top: 9px; padding: 4px 9px; border-radius: 20px; font: 700 9px/1 "DM Mono", monospace; letter-spacing: 0.1em; }
  ...
  .mif__view { position: absolute; bottom: 9px; right: 9px; display: inline-flex; align-items: center; gap: 4px;
    padding: 5px 11px; border-radius: 18px; font: 700 10px/1 "DM Mono", monospace; letter-spacing: 0.06em;
  ...
  .mif__class { font: 600 9.5px/1 "DM Mono", monospace; letter-spacing: 0.06em; text-transform: uppercase; color: #b8adcc;
    padding: 4px 8px; border-radius: 18px; border: 1px solid rgba(255,255,255,0.1); }
  ...
  .mif__more-btn { padding: 12px 26px; border-radius: 24px; cursor: pointer; font: 700 13px/1 "DM Sans", sans-serif;
